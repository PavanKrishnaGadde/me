        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              <div className="author-img" style={{backgroundImage: 'url(images/pavan.jpg)'}} />
              <h1 id="colorlib-logo"><a href="index.html">Pavan Krishna Gadde</a></h1>
              <span className="email"><i className="icon-mail"></i>pgadde@student.nitw.ac.in</span>
            </div>
