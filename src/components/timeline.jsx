                ...
                <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        <h2>Internship at SanDisk <span>2018</span></h2>
                        <p>I have done summer intership at SanDisk (Western Digital) as a Software and Hardware Intern in the Systems Design team. My major part work was on python and Verilog. I designed an application for fault detection and performance analysis</p>
                      </div>
                    </div>
                  </article>
